...
TRACE_EVENT(core_ctl_eval_need,
	...
	TP_ARGS(cpu, old_need, new_need, active_cpus, ret, need_flag, updated,
		need_ts),
	TP_STRUCT__entry(
		__field(u32, cpu)
	...
	TP_printk("cpu=%u old_need=%u new_need=%u active_cpus=%u ret=%u need_flag=%u updated=%u need_ts=%llu",
		  __entry->cpu, __entry->old_need, __entry->new_need,
